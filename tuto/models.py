...
class RoleUtilisateur(models.Model):
	...
	utilisateur=models.ForeignKey(Profilutilisateur)
...
class Connexion(models.Model):
	"""connexion"""
	id=models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
	utilisateur_demandeur=models.ForeignKey(Profilutilisateur, related_name='connexion_utilisateur_demandeur')
	utilisateur_confirmateur= models.ForeignKey(Profilutilisateur, related_name='connexion_utilisateur_confirmateur')
...
class Messages(models.Model):
	"""Messages"""
	id=models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
	utilisateur_expediteur=models.ForeignKey(Profilutilisateur, related_name='message_utilisateur_expediteur')
	utilisateur_recepteur= models.ForeignKey(Profilutilisateur, related_name='message_utilisateur_recepteur')
